...
function FormScreen({ language, passbookData, intentData, onStartOver, onBack, onStaff }) {
      ...
      <div className="bm-screen">
        ...
        <div className="bm-paper">
          ...
          <div className="bm-row">
            ...
            <span className="bm-row-val">{t("नकद निकासी", "Cash Withdrawal")}</span>
          </div>
          <div className="bm-row">
            <span className="bm-row-key">{t("राशि", "Amount")}</span>
            <span className="bm-row-val">₹{intentData.amount.toLocaleString("en-IN")}</span>
          </div>
